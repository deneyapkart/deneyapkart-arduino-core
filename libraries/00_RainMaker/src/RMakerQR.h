...
static void printQR(const char *name, const char *pop, const char *transport)
{
    ...
    Serial.printf("Bu QR kodunu ESP RainMaker telefon uygulamasından tarayın.\n");
    qrcode_display(payload);
    Serial.printf("QR kodu görünmüyorsa, aşağıdaki URL'yi kopyalayıp tarayıcıya yapıştırın.\n%s?data=%s\n", QRCODE_BASE_URL, payload);
}
