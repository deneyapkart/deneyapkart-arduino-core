...
*/
/**************************************************************************/
Adafruit_ST77xx::Adafruit_ST77xx(uint16_t w, uint16_t h, int8_t ss, int8_t dc,
                                 int8_t mosi, int8_t sclk, int8_t rst,
                                 int8_t miso)
    : Adafruit_SPITFT(w, h, ss, dc, mosi, sclk, rst, miso) {}
...
Adafruit_ST77xx::Adafruit_ST77xx(uint16_t w, uint16_t h, SPIClass *spiClass,
                                 int8_t ss, int8_t dc, int8_t rst)
    : Adafruit_SPITFT(w, h, spiClass, ss, dc, rst) {}
#endif // end !ESP8266
 ...
 *portOutputRegister(ssport) &= ~ sspin;
