...
public:
  Adafruit_ST7735(int8_t ss, int8_t dc, int8_t mosi, int8_t sclk, int8_t rst);
  Adafruit_ST7735(int8_t ss, int8_t dc, int8_t rst);
#if !defined(ESP8266)
  Adafruit_ST7735(SPIClass *spiClass, int8_t ss, int8_t dc, int8_t rst);
#endif // end !ESP8266
