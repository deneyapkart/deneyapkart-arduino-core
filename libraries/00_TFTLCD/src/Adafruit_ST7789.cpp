...
*/
Adafruit_ST7789::Adafruit_ST7789(int8_t ss, int8_t dc, int8_t mosi, int8_t sclk,
                                 int8_t rst)
    : Adafruit_ST77xx(240, 320, ss, dc, mosi, sclk, rst) {}
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7789::Adafruit_ST7789(int8_t ss, int8_t dc, int8_t rst)
    : Adafruit_ST77xx(240, 320, ss, dc, rst) {}
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_ST7789::Adafruit_ST7789(SPIClass *spiClass, int8_t ss, int8_t dc,
                                 int8_t rst)
    : Adafruit_ST77xx(240, 320, spiClass, ss, dc, rst) {}
#endif // end !ESP8266
