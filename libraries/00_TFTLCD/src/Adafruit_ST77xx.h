...
public:
  Adafruit_ST77xx(uint16_t w, uint16_t h, int8_t _SS, int8_t _DC, int8_t _MOSI,
                  int8_t _SCLK, int8_t _RST = -1, int8_t _MISO = -1);
  Adafruit_ST77xx(uint16_t w, uint16_t h, int8_t SS, int8_t RS,
                  int8_t RST = -1);
#if !defined(ESP8266)
  Adafruit_ST77xx(uint16_t w, uint16_t h, SPIClass *spiClass, int8_t SS,
